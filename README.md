...
```bash
dotnet fsi ceplas-00-contentSummary/ceplas-00-contentSummary@1.0.0.fsx ~/datahub-dataplant/Facultative-CAM-in-Talinum/
...
dotnet fsi ceplas-04-connectedData/ceplas-04-connectedData@1.0.0.fsx ~/datahub-dataplant/Facultative-CAM-in-Talinum/
```
